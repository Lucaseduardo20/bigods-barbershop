# Graph Report - bigods-barber-v2  (2026-08-25)

## Corpus Check
- 461 files · ~605,743 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4215 nodes · 9486 edges · 254 communities (233 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 145 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `79915af9`
...
2. `Dinheiro` - 124 edges
3. `UsuarioAutenticado` - 123 edges
4. `PrismaService` - 99 edges
5. `UsuarioAtual` - 93 edges
...
Cohesion: 0.08
Nodes (21): base, MAX_MENSAGEM_BUMP, BASE, agora, depois, AtendimentoProps, ItemAtendido, agendar() (+13 more)

### Community 2 - "AtendimentoId"
Cohesion: 0.10
Nodes (20): OnAtendimentoConcluidoHandler, Injectable, OnEvent, OnVendaDeProdutoRegistradaHandler, Injectable, OnEvent, RegistrarPagamentoInput, LancamentoComissao (+12 more)
...
Cohesion: 0.05
Nodes (32): AppModule, Module, hashSenha(), verificaSenha(), PrismaService, Injectable, DIA, sufixo (+24 more)
...
Cohesion: 0.05
Nodes (44): Inject, DonoDeFoto, GerenciarFotoUseCase, Inject, Injectable, ARMAZENAMENTO_DE_IMAGENS, ArmazenamentoDeImagens, ASSINATURAS (+36 more)

### Community 7 - "CompanyId"
Cohesion: 0.04
Nodes (8): PrismaParametrosRepository, Injectable, Barbeiro, BarbeiroProps, paraDominio(), PrismaBarbeiroRepository, CompanyId, Percentual

### Community 8 - "DisponibilidadeBarbeiro"
Cohesion: 0.11
Nodes (6): AgendarParams, DisponibilidadeBarbeiro, DisponibilidadeProps, paraDominio(), PrismaDisponibilidadeRepository, DisponibilidadeId
...
Cohesion: 0.12
Nodes (22): Inject, Inject, VenderPacoteInput, VenderPacoteOutput, Inject, CancelarAtendimentoClienteInput, Inject, Inject (+14 more)
...
Cohesion: 0.06
Nodes (33): ClienteAutenticado, Body, Post, Publico(), ClienteAtual, ContaCliente(), ContaClienteController, Body (+25 more)
...
Cohesion: 0.07
Nodes (23): TipoItemDeOrderBump, SolicitacaoDeReembolso, SolicitacaoDeReembolsoId, SOLICITACAO_DE_REEMBOLSO_REPOSITORY, SolicitacaoDeReembolsoRepository, paraDominio(), PrismaSolicitacaoDeReembolsoRepository, include (+15 more)
...
### Community 23 - "valorACobrarNaConclusao"
Cohesion: 0.29
...
Cohesion: 0.10
Nodes (17): ProcessarWebhookUseCase, Injectable, PAYMENT_GATEWAY, criarPaymentGateway(), exigir(), gatewayAtivo(), PaymentsModule, Module (+9 more)
...
Cohesion: 0.08
Nodes (24): DefinirExpedienteInput, DefinirExpedienteUseCase, Inject, Injectable, MaterializarExpedienteInput, MaterializarExpedienteUseCase, Injectable, DiaSemana (+16 more)

### Community 29 - "calendario.ts"
Cohesion: 0.13
Nodes (26): DataHoraLocal, diaCivilChave(), diaCivilMaisDias(), diaDaSemanaCivil(), diferencaDiasCivis(), fimDoDiaCivilMaisDias(), horaLocalHHmm(), instanteDeDataHoraLocal() (+18 more)

### Community 30 - "api"
Cohesion: 0.10
Nodes (34): FotoUpload(), useApi(), api(), limparSessao(), BOOKING_URL, VendaDeProdutoDialog(), Ajustes(), DescontoProgressivo() (+26 more)
...
Cohesion: 0.10
Nodes (23): criar(), AtualizarProdutoDto, CriarProdutoDto, paraDTO(), ProdutosController, Body, Controller, Delete (+15 more)
...
Cohesion: 0.19
Nodes (22): AlterarStatusDto, AtualizarComissaoDto, AtualizarCredenciaisDto, AtualizarPrecosDto, AtualizarServicosDto, AtualizarSlugDto, AtualizarUsuarioDto, CriarBarbeiroDto (+14 more)
...
### Community 39 - "Fechamento.tsx"
Cohesion: 0.40
Nodes (5): Fechamento(), LinhaDoFechamento(), Metrica(), primeiroDiaDoMes(), RegistrarPagamentoDialog()
...
Cohesion: 0.09
Nodes (23): Aba, ABAS_ADMIN, ABAS_BARBEIRO_NAO_ADMIN, App(), FotoDoUsuario(), icones, rotulos, Foto() (+15 more)
...
Cohesion: 0.27
Nodes (12): labelStatus, toneStatus, diferencaDias(), ehHoje(), hojeISO(), inicioDaSemana(), rotuloDiaCompleto(), somarDias() (+4 more)

### Community 45 - "dinheiro"
Cohesion: 0.14
Nodes (26): AtendimentoDetalheDialog(), Etapa, EtapaComanda(), EtapaPagamento(), FecharComandaDialog(), FORMAS, LinhaDaComanda(), ErroEstado() (+18 more)
...
Cohesion: 0.29
Nodes (8): agendar(), auth(), concluir(), DIA, extrato(), novoFone(), sufixo, tz

### Community 51 - "identity.module.ts"
Cohesion: 0.09
Nodes (21): AUTH_PROVIDER, criarIdentityProvider(), exigir(), IdentityModule, Global, Module, WhatsAppIdentityProvider, HttpWhatsAppOtpClient (+13 more)
...
### Community 54 - "ParametrosDaEmpresaRepository"
Cohesion: 0.07
Nodes (33): PAPEIS_KEY, PUBLICO_KEY, ConfirmarPagamentoPresencialUseCase, Injectable, ConfirmarReembolsoInput, ConfirmarReembolsoUseCase, Inject, Injectable (+25 more)

### Community 55 - "AuthProvider"
Cohesion: 0.12
Nodes (7): AuthProvider, LocalAuthProvider, Injectable, Inject, RolesGuard, Inject, Injectable

### Community 56 - "conta-cliente.controller.ts"
Cohesion: 0.09
Nodes (27): ConfirmarLoginClienteInput, ConfirmarLoginClienteOutput, ConfirmarLoginClienteUseCase, Inject, Injectable, IDENTITY_PROVIDER, ClienteSessaoService, Injectable (+19 more)
...
Cohesion: 0.07
Nodes (18): IniciarLoginClienteInput, IniciarLoginClienteOutput, IniciarLoginClienteUseCase, Inject, Injectable, ConfirmarLoginInput, DesafioLogin, IdentityProvider (+10 more)
...
### Community 60 - "booking/src/lib/format.ts"
Cohesion: 0.47
...
Cohesion: 0.05
Nodes (17): Servico, ServicoProps, paraDominio(), PrismaServicoRepository, ItemComposicaoPacote, PacoteOferta, PacoteOfertaProps, PACOTE_OFERTA_REPOSITORY (+9 more)
...
Cohesion: 0.10
Nodes (20): PacoteOfertasQueryService, Inject, Injectable, ClientePublicoDto, PacotesPublicoController, Controller, Inject, IsOptional (+12 more)
...
Cohesion: 0.06
Nodes (25): CarrinhoPrecificado, ItemDoCarrinho, ItemPrecificado, precificarCarrinho(), ItemDeOrderBumpProps, ContextoValidacaoPacoteOferta, contexto(), criar() (+17 more)
...
Cohesion: 0.08
Nodes (29): CLIENTE_DA_CASA_REPOSITORY, ClienteDaCasaRepository, PrismaClienteDaCasaRepository, Injectable, SolicitacaoDeReembolsoProps, ItemDoPacote, ItemParaVenda, VendaDePacoteProps (+21 more)

### Community 85 - "payroll.module.ts"
Cohesion: 0.16
Nodes (10): RegistrarPagamentoUseCase, Inject, Injectable, PayrollModule, Module, ComissaoController, Controller, Inject (+2 more)
...
### Community 106 - "Timezone"
Cohesion: 0.07
Nodes (18): AgendaQueryService, AtendimentoComItens, ORDEM_DA_COMANDA, Injectable, Timezone, agenda, prisma, publisherSilencioso (+10 more)
...
### Community 118 - "atendimentos.controller.ts"
Cohesion: 0.07
Nodes (36): Inject, precoDeReferencia(), IntencaoDePagamentoRepository, AdicionarItemAtendimentoUseCase, Injectable, AdicionarProdutoAtendimentoUseCase, Injectable, AgendarAvulsoUseCase (+28 more)

### Community 119 - "ItemDeOrderBump"
Cohesion: 0.10
Nodes (4): ItemDeOrderBump, criar(), paraDominio(), PrismaItemDeOrderBumpRepository
...
Cohesion: 0.06
Nodes (45): SERVICO_REPOSITORY, ServicoRepository, CLIENTE_REPOSITORY, ClienteRepository, MarcarDaCasaDto, Inject, IsOptional, IsString (+37 more)
...
Cohesion: 0.04
Nodes (28): ClienteProps, NOME_PLACEHOLDER, criar(), Telefone, DIA, e164(), sufixo, DIA (+20 more)
...
### Community 172 - "OnPacoteVendidoHandler"
Cohesion: 0.33
...
Cohesion: 0.20
Nodes (7): AprovarValeUseCase, Inject, Injectable, NegarValeUseCase, Inject, Injectable, Inject
...
### Community 225 - "marcar-vale-pago.usecase.ts"
Cohesion: 0.33
Nodes (4): MarcarValePagoInput, MarcarValePagoUseCase, Inject, Injectable

### Community 230 - "venda-de-pacote.spec.ts"
Cohesion: 0.20
...
### Community 242 - "AgendarCreditoDialog"
Cohesion: 0.50
Nodes (3): idEfetivo(), Extrato(), AgendarCreditoDialog()
...
### Community 257 - "JanelaExpedienteDto"
Cohesion: 0.67
Nodes (3): JanelaExpedienteDto, Matches, MaxLength

## Knowledge Gaps
- **1214 isolated node(s):** `name`, `version`, `private`, `type`, `build` (+1209 more)
...
- **Why does `UsuarioAutenticado` connect `UsuarioAutenticado` to `AtendimentoId`, `PacoteOfertasController`, `PrismaService`, `.definir`, `CompanyId`, `PacotesController`, `UnitOfWork`, `UsuarioAtual`, `.atualizar`, `Papeis`, `materializar-expediente.usecase.ts`, `produtos.controller.ts`, `EditarComandaUseCase`, `.criar`, `vales.controller.ts`, `barbeiros.controller.ts`, `identity.module.ts`, `ParametrosDaEmpresaRepository`, `AuthProvider`, `vendas-produto.controller.ts`, `ServicoId`, `ValesController`, `ClientesController`, `BarbeiroId`, `payroll.module.ts`, `.configurar`, `atendimentos.controller.ts`, `agendar-avulso.usecase.ts`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `CompanyId` connect `CompanyId` to `dinheiro.ts`, `AtendimentoId`, `DisponibilidadeBarbeiro`, `VendaDePacote`, `Cliente`, `Atendimento`, `fechamento-query.service.ts`, `shared.module.ts`, `materializar-expediente.usecase.ts`, `Telefone`, `vales.controller.ts`, `Vale`, `PrismaAtendimentoRepository`, `ParametrosDaEmpresaRepository`, `ServicoId`, `Dinheiro`, `BarbeiroId`, `Produto`, `VendaDeProduto`, `Timezone`, `UsuarioAutenticado`, `ItemDeOrderBump`, `agendar-avulso.usecase.ts`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `Cliente` connect `Cliente` to `dinheiro.ts`, `Telefone`, `UnitOfWork`, `shared.module.ts`, `conta-cliente.controller.ts`, `agendar-avulso.usecase.ts`?**
