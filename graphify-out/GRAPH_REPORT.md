# Graph Report - bigods-barber-v2  (2026-08-27)

## Corpus Check
- 472 files · ~632,277 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4363 nodes · 9843 edges · 282 communities (257 shown, 25 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 148 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `132856d4`
...
1. `CompanyId` - 139 edges
2. `UsuarioAutenticado` - 130 edges
3. `Dinheiro` - 125 edges
4. `PrismaService` - 101 edges
5. `UsuarioAtual` - 96 edges
6. `BarbeiroId` - 81 edges
7. `Atendimento` - 76 edges
8. `Barbeiro` - 69 edges
9. `api()` - 66 edges
...
Cohesion: 0.05
Nodes (74): App(), CockpitOuBook(), Conta(), Tela, ChamadoDoClube(), ChamadoDoClubeTexto, chamadoParaStatus(), ehMembro() (+66 more)

### Community 1 - "Dinheiro"
Cohesion: 0.06
Nodes (37): CarrinhoPrecificado, ItemDoCarrinho, ItemPrecificado, precificarCarrinho(), ServicoProps, base, ItemDeOrderBumpProps, BASE (+29 more)

### Community 2 - "LancamentoComissao"
Cohesion: 0.08
Nodes (27): CLIENTE_DA_CASA_REPOSITORY, OnAtendimentoConcluidoHandler, Inject, Injectable, OnVendaDeProdutoRegistradaHandler, Inject, Injectable, OnEvent (+19 more)
...
Cohesion: 0.04
Nodes (35): AppModule, Module, hashSenha(), verificaSenha(), PagamentoStatusQueryService, Injectable, PrismaService, Injectable (+27 more)
...
Cohesion: 0.04
Nodes (14): Inject, ItemComposicaoPacote, Inject, AtendimentoAgendado, AtendimentoCancelado, ClienteFaltou, ItemAtendidoSnapshot, Barbeiro (+6 more)

### Community 8 - "auth-provider.ts"
Cohesion: 0.13
Nodes (17): PAPEIS_KEY, PUBLICO_KEY, AtualizarParametrosDto, DefinirDescontoDto, DegrauDto, IsArray, IsInt, IsOptional (+9 more)

### Community 9 - "VendaDePacote"
Cohesion: 0.06
Nodes (4): somaDeReferencia(), VendaDePacote, paraDominio(), PrismaVendaDePacoteRepository
...
Cohesion: 0.10
Nodes (23): ClienteDaCasaRepository, PrismaClienteDaCasaRepository, Injectable, ItemDoPacote, ItemParaVenda, VendaDePacoteProps, ItemDoPacoteConsumido, ItemDoPacoteExpirado (+15 more)
...
Cohesion: 0.15
Nodes (12): calcularSaldoCentavos(), sinalDoTipo(), TIPOS_QUE_SOMAM, SaldoComissao, acumularEm(), FechamentoQueryService, Totais, totaisVazios() (+4 more)

### Community 19 - "UsuarioAutenticado"
Cohesion: 0.13
Nodes (18): UsuarioAutenticado, Get, Put, UsuarioAtual, Get, Query, CorrigirBarbeiroDoAtendimentoInput, AdicionarItemAtendimentoInput (+10 more)
...
Cohesion: 0.13
Nodes (21): AtendimentoDetalheDialog(), labelStatus, toneStatus, Etapa, EtapaComanda(), EtapaPagamento(), FecharComandaDialog(), FORMAS (+13 more)

### Community 24 - ".atualizar"
Cohesion: 0.24
Nodes (8): paraDTO(), ServicosController, Body, Controller, Get, Param, Patch, Post
...
### Community 29 - "Timezone"
Cohesion: 0.07
Nodes (33): ticketMedioCentavos(), diaCivilChave(), diaCivilMaisDias(), Timezone, agendarAvulso(), auth(), detalhe(), DIA (+25 more)

### Community 30 - "api"
Cohesion: 0.12
Nodes (25): Foto(), FotoUpload(), iniciais(), api(), BOOKING_URL, DescontoProgressivo(), MinhaFoto(), MinhaSenha() (+17 more)
...
### Community 33 - "Papeis"
Cohesion: 0.12
Nodes (17): Papeis(), Body, Param, Post, Get, Query, paraDTO(), ProdutosController (+9 more)
...
### Community 35 - "HomeController"
Cohesion: 0.50
Nodes (3): HomeController, Controller, Get
...
Cohesion: 0.16
Nodes (25): AlterarStatusDto, AtualizarAcertoDto, AtualizarComissaoDto, AtualizarCredenciaisDto, AtualizarPrecosDto, AtualizarServicosDto, AtualizarSlugDto, AtualizarUsuarioDto (+17 more)
...
### Community 39 - "ParametrosDaEmpresaRepository"
Cohesion: 0.07
Nodes (41): ClienteRepository, ConfirmarLoginClienteUseCase, Injectable, THROTTLE_LOGIN, Inject, PARAMETROS_DA_EMPRESA_REPOSITORY, ParametrosDaEmpresaRepository, VENDA_DE_PACOTE_REPOSITORY (+33 more)

### Community 40 - "Decisões Pendentes"
Cohesion: 0.03
Nodes (61): 10. Versão/base da API do AbacatePay — ✅ RESOLVIDO (sessão de ligação do pagamento online): v2, Checkout Transparente, 11. Webhook do AbacatePay só é MONTADO com o gateway real, 12. Catálogo de ofertas de pacote (`PacoteOferta`) não é modelado no domínio — ✅ RESOLVIDO (sessão-B, Fase 1), 13. Produtos: SEM controle de estoque (decisão consciente, pedida explicitamente), 14. CRUD de ofertas de pacote (DECISOES #10) e CRUD de produtos: consistência a médio prazo — ✅ RESOLVIDO (sessão-B, Fase 1), 15. Granularidade do expediente: uma janela por dia na UI do admin, 16. Nome placeholder para Cliente criado só pelo login (bug 2, sessão 2026-07-20), 17. RASCUNHO de `PacoteOferta`: nenhum gatilho de UI o produz (sessão-B, Fase 3) (+53 more)

### Community 41 - "admin/src/App.tsx"
Cohesion: 0.09
Nodes (24): Aba, ABAS_ADMIN, ABAS_BARBEIRO_NAO_ADMIN, App(), FotoDoUsuario(), icones, rotulos, BotaoSair() (+16 more)
...
Cohesion: 0.24
Nodes (9): idEfetivo(), ehDebito(), ehEstorno(), Extrato(), Financeiro(), LinhaDoExtrato(), SaldoLiquido(), SubAba (+1 more)

### Community 46 - "Relatório da Sessão — Bigod's Barber v2"
Cohesion: 0.06
Nodes (35): Ajustes no painel admin (sessão 2026-07-15) ✅, Avulso online dispensa o OTP (2026-08-14) ✅, Checklist de smoke test manual (ponta a ponta — rodar antes do dia 20), Como rodar localmente, Correção de fuso horário (sessão 2026-07-14, continuação) ✅, Correção: prazo de pagamento do pacote volta a ser 1h (2026-08-14) ✅, CRUD de usuários staff/admin no painel (2026-08-12) ✅, Decisões pendentes (DECISOES_PENDENTES.md) (+27 more)

### Community 47 - "CompanyId"
Cohesion: 0.08
Nodes (15): PrismaParametrosRepository, Injectable, OnEvent, criar(), EntradaDosLancamentos, ItemParaComissao, lancamentosDoAtendimentoConcluido(), ProdutoParaComissao (+7 more)
...
Cohesion: 0.09
Nodes (21): ConfirmarPagamentoPresencialUseCase, Injectable, ConfirmarReembolsoInput, ConfirmarReembolsoUseCase, Inject, Injectable, SolicitarReembolsoInput, SolicitarReembolsoOutput (+13 more)

### Community 55 - "AuthProvider"
Cohesion: 0.11
Nodes (9): AuthProvider, LocalAuthProvider, Injectable, AuthController, Controller, Inject, RolesGuard, Inject (+1 more)

### Community 56 - "cliente.guard.ts"
Cohesion: 0.18
Nodes (7): ClienteSessaoService, Injectable, ClienteAtualOpcional, ClienteGuard, ClienteGuardOpcional, Inject, Injectable

### Community 57 - "Pacotes.tsx"
Cohesion: 0.13
Nodes (26): AcaoDeItem, BadgeDeItem, CabecalhoDeCatalogo(), EstadoDaLista(), ItemDeCatalogo(), Badge(), BotaoAtualizar(), CurrencyInput() (+18 more)

### Community 58 - "identity.module.ts"
Cohesion: 0.06
Nodes (26): IniciarLoginClienteInput, IniciarLoginClienteOutput, IniciarLoginClienteUseCase, Inject, Injectable, OnPacoteVendidoHandler, Inject, Injectable (+18 more)
...
Cohesion: 0.08
Nodes (17): PACOTE_OFERTA_REPOSITORY, SolicitacaoDeReembolso, SolicitacaoDeReembolsoId, SOLICITACAO_DE_REEMBOLSO_REPOSITORY, SolicitacaoDeReembolsoRepository, LinhaComItens, paraDominio(), PrismaSolicitacaoDeReembolsoRepository (+9 more)
...
Cohesion: 0.08
Nodes (5): PacoteOferta, PacoteOfertaRepository, paraDominio(), PrismaPacoteOfertaRepository, Inject

### Community 63 - "AgendarAvulsoDto"
Cohesion: 0.14
Nodes (22): AdicionarItemDto, AdicionarProdutoDto, AgendarAvulsoDto, AgendarComCreditoDto, CancelarDto, ClienteInlineDto, ConcluirDto, ReatribuirDto (+14 more)
...
### Community 69 - "fuso-horario.spec.ts"
Cohesion: 0.11
Nodes (13): ExpirarItensJob, Cron, Inject, Injectable, AgendaQueryService, AtendimentoComItens, ORDEM_DA_COMANDA, Injectable (+5 more)

### Community 70 - "calendario.ts"
Cohesion: 0.15
Nodes (15): HorariosDisponiveisQueryService, Inject, Injectable, DataHoraLocal, diferencaDiasCivis(), fimDoDiaCivilMaisDias(), horaLocalHHmm(), instanteDeLocal() (+7 more)

### Community 71 - "ValesController"
Cohesion: 0.24
Nodes (7): Body, Controller, Get, Param, Patch, Post, ValesController

### Community 72 - "CobrancaOnlineService"
Cohesion: 0.40
Nodes (3): Inject, CobrancaOnlineService, Injectable
...
Cohesion: 0.08
Nodes (16): vendaPaga(), contexto(), criar(), hoje, item(), prazo10, tz, vender() (+8 more)
...
Cohesion: 0.22
Nodes (10): Publico(), ContaClienteOpcional(), precoDeReferencia(), BookingPublicoController, Body, Controller, Get, Post (+2 more)

### Community 85 - "dinheiro"
Cohesion: 0.17
Nodes (15): useApi(), dinheiro(), VendaDeProdutoDialog(), Produtos(), Servicos(), ConfiguracaoDeOrderBump(), OfertaDialog(), percentual() (+7 more)
...
### Community 92 - ".executar"
Cohesion: 0.15
Nodes (9): ajustesDe(), ConcluirAtendimentoUseCase, consumirCreditosDePacote(), Inject, Injectable, AprovarConclusaoAntecipadaUseCase, RecusarConclusaoAntecipadaUseCase, Inject (+1 more)
...
Cohesion: 0.20
Nodes (15): diferencaDias(), ehHoje(), hojeISO(), inicioDaSemana(), rotuloDiaCompleto(), somarDias(), Agenda(), diaCurtoLabel() (+7 more)
...
Cohesion: 0.14
Nodes (12): RegistrarPagamentoUseCase, Injectable, PagamentosController, RegistrarPagamentoDto, Body, Controller, IsNumber, IsOptional (+4 more)
...
### Community 108 - ".executar"
Cohesion: 0.17
Nodes (4): criar(), janela(), e164(), e164()

### Community 109 - "OtpVerificacao.tsx"
Cohesion: 0.12
Nodes (13): App(), IconeDeMarca(), IconeWhatsapp(), Props, OtpVerificacao(), PagamentoManualAguardando(), ApiError, BARBEARIA (+5 more)
...
### Community 111 - "ParametrosController"
Cohesion: 0.20
...
Cohesion: 0.29
Nodes (5): bootstrap(), sentryLigado, assertConfiguracaoSegura(), ConfiguracaoInseguraError, iniciarSentry()
...
Cohesion: 0.04
Nodes (25): Servico, SERVICO_REPOSITORY, ServicoRepository, paraDominio(), PrismaServicoRepository, Inject, ItemDeOrderBump, MAX_MENSAGEM_BUMP (+17 more)
...
### Community 123 - "materializar-expediente.usecase.ts"
Cohesion: 0.22
Nodes (8): MaterializarExpedienteInput, MaterializarExpedienteUseCase, Injectable, MaterializarExpedienteJob, Cron, Injectable, StaffModule, Module

### Community 124 - "integration.spec.ts"
Cohesion: 0.11
Nodes (11): EditarComandaUseCase, motivoParaNaoMexerNoValor(), Inject, Injectable, RepositoriosTransacionais, PrismaUnitOfWork, repositoriosDe(), Injectable (+3 more)
...
### Community 132 - "ProcessarWebhookUseCase"
Cohesion: 0.10
Nodes (14): Inject, ExpirarPagamentoVencidoUseCase, Inject, Injectable, ProcessarWebhookUseCase, Inject, Injectable, extrairExternalId() (+6 more)
...
### Community 162 - "UnitOfWork"
Cohesion: 0.11
Nodes (27): ConfirmarLoginClienteInput, ConfirmarLoginClienteOutput, Inject, VenderPacoteInput, VenderPacoteOutput, CorrigirBarbeiroResultado, MarcarValePagoInput, CancelarAtendimentoClienteInput (+19 more)

### Community 163 - "app.module.ts"
Cohesion: 0.04
Nodes (33): THROTTLER_OTP_ORIGEM, CatalogModule, Module, CustomersModule, Module, FunnelModule, Module, IdentityModule (+25 more)

### Community 164 - "MarcarValePagoUseCase"
Cohesion: 0.40
Nodes (3): MarcarValePagoUseCase, Inject, Injectable
...
### Community 196 - "ComissaoQueryService"
Cohesion: 0.22
Nodes (5): ComissaoQueryService, Injectable, ComissaoController, Controller, Inject
...
### Community 225 - "payroll.module.ts"
Cohesion: 0.11
Nodes (17): AprovarValeInput, AprovarValeUseCase, Inject, Injectable, NegarValeInput, NegarValeUseCase, Inject, Injectable (+9 more)
...
Cohesion: 0.11
Nodes (9): CLIENTE_REPOSITORY, VenderProdutoAvulsoInput, VendaDeProduto, VENDA_DE_PRODUTO_REPOSITORY, VendaDeProdutoRepository, include, paraDominio(), PrismaVendaDeProdutoRepository (+1 more)

### Community 238 - "dias-da-semana.ts"
Cohesion: 0.28
Nodes (11): aos(), descricaoCurtaDosDias(), descricaoDosDias(), diasNormalizados(), NOME_CURTO, NOME_LONGO, nomeCurtoDoDia(), nomeDoDia() (+3 more)

### Community 240 - "CancelarReservaOnlineUseCase"
Cohesion: 0.40
...
### Community 247 - "expediente-semanal.aggregate.ts"
Cohesion: 0.36
Nodes (7): DefinirExpedienteInput, DiaSemana, JanelaExpediente, EXPEDIENTE_SEMANAL_REPOSITORY, JanelaExpedienteDto, Matches, MaxLength
...
Cohesion: 0.19
Nodes (12): ResultadoDaCobranca, Inject, PAYMENT_GATEWAY, PaymentGateway, FakeAbacatePayGateway, Injectable, criarPaymentGateway(), exigir() (+4 more)

### Community 251 - "ExpedienteSemanalRepository"
Cohesion: 0.18
Nodes (6): DefinirExpedienteUseCase, Inject, Injectable, Inject, ExpedienteSemanalRepository, Inject
...
### Community 267 - "pacote-publico.e2e.spec.ts"
Cohesion: 0.29
Nodes (3): e164(), fetchMock, sufixo

### Community 268 - "CorrigirBarbeiroDoAtendimentoUseCase"
Cohesion: 0.40
Nodes (3): CorrigirBarbeiroDoAtendimentoUseCase, Inject, Injectable

### Community 269 - "ReatribuirBarbeiroUseCase"
Cohesion: 0.40
Nodes (3): ReatribuirBarbeiroUseCase, Inject, Injectable

### Community 271 - "8.15 Dias da semana em que o crédito de pacote vale (2026-08-28)"
Cohesion: 0.33
...
### Community 272 - "CancelarAtendimentoUseCase"
Cohesion: 0.40
Nodes (3): CancelarAtendimentoUseCase, Inject, Injectable

### Community 273 - "MarcarDaCasaDto"
Cohesion: 0.50
Nodes (4): MarcarDaCasaDto, IsOptional, IsString, MinLength

### Community 274 - "LoginDto"
Cohesion: 0.67
Nodes (4): LoginDto, TrocarSenhaDto, IsString, MinLength

### Community 275 - ".extrato"
Cohesion: 0.50
Nodes (3): paraDTO(), Get, Param

### Community 277 - "Rosto do barbeiro no funil, e foto para admin (2026-08-21) ✅"
Cohesion: 0.50
...
## Knowledge Gaps
- **1267 isolated node(s):** `name`, `version`, `private`, `type`, `build` (+1262 more)
...
- **Why does `UsuarioAutenticado` connect `UsuarioAutenticado` to `.definir`, `LancamentoComissao`, `PacoteOfertasController`, `PrismaService`, `auth-provider.ts`, `.criar`, `BarbeiroId`, `.extrato`, `.atualizar`, `BarbeirosController`, `Papeis`, `UnitOfWork`, `HomeController`, `barbeiros.controller.ts`, `ParametrosDaEmpresaRepository`, `CompanyId`, `packages.module.ts`, `AuthProvider`, `vendas-produto.controller.ts`, `ValesController`, `ClientesController`, `expediente-semanal.aggregate.ts`, `.executar`, `payroll.module.ts`, `pagamentos.controller.ts`, `ParametrosController`, `.configurar`, `agendar-avulso.usecase.ts`, `integration.spec.ts`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `PrismaService` connect `PrismaService` to `cadastro-nao-sobrescreve.e2e.spec.ts`, `LancamentoComissao`, `s3-armazenamento.ts`, `conta-cockpit.e2e.spec.ts`, `otp-sem-conta.e2e.spec.ts`, `cockpit-cliente-autonomia.e2e.spec.ts`, `BarbeiroId`, `pacote-publico.e2e.spec.ts`, `sem-preferencia.e2e.spec.ts`, `fechamento-query.service.ts`, `EmpresaPublicaQueryService`, `Timezone`, `conclusao-antecipada.e2e.spec.ts`, `app.module.ts`, `barbeiros.controller.ts`, `ParametrosDaEmpresaRepository`, `CompanyId`, `caixinha-e-desconto.e2e.spec.ts`, `whatsapp-identity.provider.ts`, `packages.module.ts`, `AuthProvider`, `identity.module.ts`, `vendas-produto.controller.ts`, `shared.module.ts`, `ComissaoQueryService`, `fuso-horario.spec.ts`, `calendario.ts`, `bigods-club-status.e2e.spec.ts`, `ClubeHandlers`, `payroll.module.ts`, `reativar-cancelamento.e2e.spec.ts`, `seed-producao.ts`, `AgendamentosClienteQueryService`, `visita-multiplos-creditos.e2e.spec.ts`, `payments.module.ts`, `materializar-expediente.usecase.ts`, `integration.spec.ts`, `conta-cliente.e2e.spec.ts`, `dias-permitidos.e2e.spec.ts`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `UsuarioAtual` connect `UsuarioAutenticado` to `.definir`, `LancamentoComissao`, `PacoteOfertasController`, `PrismaService`, `auth-provider.ts`, `.criar`, `.extrato`, `.atualizar`, `BarbeirosController`, `Papeis`, `HomeController`, `barbeiros.controller.ts`, `ParametrosDaEmpresaRepository`, `packages.module.ts`, `vendas-produto.controller.ts`, `ValesController`, `ClientesController`, `expediente-semanal.aggregate.ts`, `payroll.module.ts`, `pagamentos.controller.ts`, `ParametrosController`, `.configurar`, `agendar-avulso.usecase.ts`?**
