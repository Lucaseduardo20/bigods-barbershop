...
## Corpus Check
- 437 files · ~573,601 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4017 nodes · 9040 edges · 244 communities (224 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 138 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `72242ccd`
...
Cohesion: 0.08
Nodes (29): CarrinhoPrecificado, ItemDoCarrinho, ItemPrecificado, ServicoProps, base, ItemDeOrderBumpProps, MAX_MENSAGEM_BUMP, BASE (+21 more)

### Community 2 - "payroll.module.ts"
Cohesion: 0.05
Nodes (42): MarcarValePagoInput, MarcarValePagoUseCase, Inject, Injectable, OnAtendimentoConcluidoHandler, Inject, Injectable, OnEvent (+34 more)

### Community 3 - "PacoteOferta"
Cohesion: 0.07
Nodes (12): ItemComposicaoPacote, PacoteOferta, PacoteOfertaProps, PACOTE_OFERTA_REPOSITORY, PacoteOfertaRepository, criar(), LinhaComItens, paraDominio() (+4 more)

### Community 4 - "PrismaService"
Cohesion: 0.05
Nodes (32): AppModule, Module, hashSenha(), PrismaService, Injectable, DIA, sufixo, DIA (+24 more)
...
Cohesion: 0.04
Nodes (7): ItemAtendidoSnapshot, Barbeiro, BarbeiroProps, paraDominio(), PrismaBarbeiroRepository, ServicoId, Percentual

### Community 8 - "DisponibilidadeBarbeiro"
Cohesion: 0.09
Nodes (8): DisponibilidadeBarbeiro, DisponibilidadeProps, DisponibilidadeRepository, janela(), paraDominio(), PrismaDisponibilidadeRepository, DisponibilidadeId, IntervaloDeTempo
...
Cohesion: 0.10
Nodes (25): Inject, Inject, Inject, Inject, CancelarAtendimentoClienteInput, CancelarAtendimentoUseCase, Inject, Injectable (+17 more)
...
Cohesion: 0.11
Nodes (6): PrismaParametrosRepository, Injectable, IntencaoDePagamentoProps, PagamentoConfirmado, CompanyId, IntencaoDePagamentoId
...
Cohesion: 0.07
Nodes (23): TipoItemDeOrderBump, ITEM_DE_ORDER_BUMP_REPOSITORY, ItemDeOrderBumpRepository, PrismaItemDeOrderBumpRepository, SolicitacaoDeReembolso, SolicitacaoDeReembolsoId, SOLICITACAO_DE_REEMBOLSO_REPOSITORY, SolicitacaoDeReembolsoRepository (+15 more)

### Community 22 - ".deCentavos"
Cohesion: 0.06
Nodes (25): contexto(), ItemParaVenda, hoje, item(), prazo10, tz, vender(), venderPago() (+17 more)
...
Cohesion: 0.25
Nodes (10): assertNaoRemoveUltimoAdminAtivo(), BarbeirosController, paraDTO(), paraUsuarioDTO(), Body, Controller, Delete, Get (+2 more)
...
Cohesion: 0.05
Nodes (20): ResultadoDaCobranca, Inject, DadosDaComanda, dinheiro(), LinhaDaComanda, linkDaComanda(), montarComanda(), AVULSO (+12 more)

### Community 28 - "ExpedienteSemanal"
Cohesion: 0.14
Nodes (5): ExpedienteSemanal, ExpedienteSemanalRepository, agruparPorBarbeiro(), paraDominio(), PrismaExpedienteSemanalRepository

### Community 29 - "calendario.ts"
Cohesion: 0.08
Nodes (35): AtendimentoComItens, DataHoraLocal, diaCivilChave(), diaCivilMaisDias(), diaDaSemanaCivil(), diferencaDiasCivis(), fimDoDiaCivilMaisDias(), instanteDeDataHoraLocal() (+27 more)
...
Cohesion: 0.06
Nodes (21): THROTTLER_OTP_ORIGEM, CustomersModule, Module, FunnelModule, Module, ENVIA_OTP, EnviaOtp(), rotaEnviaOtp() (+13 more)
...
Cohesion: 0.09
Nodes (24): AtualizarProdutoDto, CriarProdutoDto, paraDTO(), ProdutosController, Body, Controller, Delete, Get (+16 more)
...
### Community 36 - "Vale"
Cohesion: 0.05
Nodes (28): AprovarValeInput, AprovarValeUseCase, Inject, Injectable, NegarValeInput, NegarValeUseCase, Inject, Injectable (+20 more)

### Community 37 - "barbeiros.controller.ts"
Cohesion: 0.15
Nodes (25): slugDoNome(), slugUnico(), AlterarStatusDto, AtualizarComissaoDto, AtualizarCredenciaisDto, AtualizarPrecosDto, AtualizarServicosDto, AtualizarSlugDto (+17 more)
...
Cohesion: 0.09
Nodes (40): ConfirmarLoginClienteUseCase, Injectable, IniciarLoginClienteUseCase, Injectable, THROTTLE_LOGIN, Inject, PARAMETROS_DA_EMPRESA_REPOSITORY, ParametrosDaEmpresaRepository (+32 more)
...
Cohesion: 0.09
Nodes (26): SERVICO_REPOSITORY, ServicoRepository, Inject, Inject, VenderPacoteInput, VenderPacoteOutput, precoDeReferencia(), CobrancaOnlineService (+18 more)
...
Cohesion: 0.07
Nodes (26): ConfirmarPagamentoPresencialUseCase, Injectable, ConfirmarReembolsoInput, ConfirmarReembolsoUseCase, Inject, Injectable, SolicitarReembolsoInput, SolicitarReembolsoOutput (+18 more)

### Community 55 - "identity.module.ts"
Cohesion: 0.06
Nodes (26): AUTH_PROVIDER, AuthProvider, criarIdentityProvider(), exigir(), IdentityModule, Global, Module, DemoIdentityProvider (+18 more)

### Community 56 - "pacotes-publico.controller.ts"
Cohesion: 0.07
Nodes (27): ClienteProps, NOME_PLACEHOLDER, CLIENTE_REPOSITORY, ClienteRepository, MarcarDaCasaDto, Inject, IsOptional, IsString (+19 more)
...
Cohesion: 0.08
Nodes (16): Inject, OnPacoteVendidoHandler, Inject, Injectable, OnEvent, ConfirmarLoginInput, DesafioLogin, IdentityProvider (+8 more)
...
Cohesion: 0.09
Nodes (6): somaDeReferencia(), VendaDeProduto, VendaDeProdutoRepository, registrar(), paraDominio(), PrismaVendaDeProdutoRepository
...
### Community 69 - ".vender"
Cohesion: 0.18
Nodes (7): paraDTO(), Body, Get, Param, Post, Query, Throttle

### Community 70 - "HorariosDisponiveisQueryService"
Cohesion: 0.24
Nodes (4): HorariosDisponiveisQueryService, Inject, Injectable, horaLocalHHmm()
...
Cohesion: 0.12
Nodes (16): CLIENTE_DA_CASA_REPOSITORY, ClienteDaCasaRepository, PrismaClienteDaCasaRepository, Injectable, SolicitacaoDeReembolsoProps, ItemDoPacote, VendaDePacoteProps, ItemDoPacoteConsumido (+8 more)
...
Cohesion: 0.10
Nodes (3): ItemDeOrderBump, criar(), paraDominio()
...
### Community 104 - "DefinirExpedienteUseCase"
Cohesion: 0.20
Nodes (5): DefinirExpedienteUseCase, Inject, Injectable, validarJanelas(), Inject

### Community 105 - "payments.module.ts"
Cohesion: 0.08
Nodes (21): ExpirarPagamentoVencidoUseCase, Inject, Injectable, ProcessarWebhookUseCase, Injectable, PAYMENT_GATEWAY, PagamentoStatusQueryService, Injectable (+13 more)
...
Cohesion: 0.12
Nodes (14): Papeis(), PAPEIS_KEY, PUBLICO_KEY, FechamentoController, Controller, Get, Query, HomeController (+6 more)
...
### Community 118 - "ConcluirAtendimentoUseCase"
Cohesion: 0.38
...
### Community 160 - ".executar"
Cohesion: 0.20
Nodes (3): precificarCarrinho(), criar(), criar()
...
Cohesion: 0.42
Nodes (6): DefinirExpedienteInput, MaterializarExpedienteInput, DiaSemana, ExpedienteSemanalProps, JanelaExpediente, EXPEDIENTE_SEMANAL_REPOSITORY
...
### Community 197 - "Deploy abstraído: um comando pra local/staging/produção (2026-08-10) ✅"
Cohesion: 0.50
...
## Knowledge Gaps
- **1141 isolated node(s):** `name`, `version`, `private`, `type`, `build` (+1136 more)
...
- **Why does `Cliente` connect `Cliente` to `.executar`, `Dinheiro`, `agendar-avulso.usecase.ts`, `booking-publico.controller.ts`, `shared.module.ts`, `pacotes-publico.controller.ts`?**
