...
## Corpus Check
- 440 files · ~576,733 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4040 nodes · 9064 edges · 251 communities (230 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 140 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2cb6511e`
...
- Pacotes.tsx
- identity.module.ts
- vender-produto-avulso.usecase.ts
- VendaDeProduto
- Confirmacao.tsx
...
## Communities (251 total, 21 thin omitted)
...
Cohesion: 0.09
Nodes (19): base, barbeiro, ocorridoEm, agora, depois, ItemAtendido, agendar(), barbeiro (+11 more)

### Community 2 - "payroll.module.ts"
Cohesion: 0.07
Nodes (29): MarcarValePagoInput, OnAtendimentoConcluidoHandler, Inject, Injectable, OnVendaDeProdutoRegistradaHandler, Inject, Injectable, RegistrarPagamentoInput (+21 more)

### Community 3 - "Servico"
Cohesion: 0.05
Nodes (20): Servico, ServicoProps, SERVICO_REPOSITORY, ServicoRepository, paraDominio(), PrismaServicoRepository, ContextoValidacaoPacoteOferta, ItemComposicaoPacote (+12 more)
...
Cohesion: 0.06
Nodes (5): Barbeiro, BarbeiroRepository, paraDominio(), PrismaBarbeiroRepository, ServicoId

### Community 8 - "DisponibilidadeBarbeiro"
Cohesion: 0.12
Nodes (7): DisponibilidadeBarbeiro, DisponibilidadeProps, DisponibilidadeRepository, paraDominio(), PrismaDisponibilidadeRepository, Inject, DisponibilidadeId
...
Cohesion: 0.14
Nodes (19): Inject, Inject, CancelarAtendimentoClienteInput, Inject, CancelarReservaOnlineInput, ConcluirAtendimentoResultado, CONCLUSAO_ANTECIPADA_EXIGE_MOTIVO, Inject (+11 more)

### Community 12 - "Cliente"
Cohesion: 0.09
Nodes (5): confirmarLogin(), Cliente, ClienteRepository, paraDominio(), PrismaClienteRepository
...
Cohesion: 0.18
Nodes (13): VenderPacoteInput, VenderPacoteOutput, ResultadoDaCobranca, CobrancaPix, PAYMENT_GATEWAY, PaymentGateway, FakeAbacatePayGateway, Injectable (+5 more)

### Community 16 - "Atendimento"
Cohesion: 0.05
Nodes (4): Atendimento, paraDominio(), PrismaAtendimentoRepository, janela()
...
Cohesion: 0.09
Nodes (19): PrismaParametrosRepository, Injectable, OnEvent, pagamento(), vale(), ValeProps, ProdutoProps, ItemVendaDeProduto (+11 more)

### Community 19 - "UsuarioAutenticado"
Cohesion: 0.07
Nodes (32): UsuarioAutenticado, Get, UsuarioAtual, ParametrosController, Body, Controller, Get, Inject (+24 more)
...
Cohesion: 0.07
Nodes (22): SolicitacaoDeReembolso, SolicitacaoDeReembolsoId, SOLICITACAO_DE_REEMBOLSO_REPOSITORY, SolicitacaoDeReembolsoRepository, LinhaComItens, paraDominio(), PrismaSolicitacaoDeReembolsoRepository, include (+14 more)

### Community 22 - "Dinheiro"
Cohesion: 0.06
Nodes (20): CarrinhoPrecificado, ItemDoCarrinho, ItemPrecificado, contexto(), criar(), SolicitacaoDeReembolsoProps, hoje, item() (+12 more)
...
Cohesion: 0.08
Nodes (11): MaterializarExpedienteUseCase, Inject, Injectable, ExpedienteSemanal, validarJanelas(), MaterializarExpedienteJob, Cron, Injectable (+3 more)
...
Cohesion: 0.05
Nodes (29): THROTTLER_OTP_ORIGEM, CatalogModule, Module, CustomersModule, Module, FunnelModule, Module, IdentityModule (+21 more)
...
### Community 47 - "agendar-avulso.usecase.ts"
Cohesion: 0.08
Nodes (35): precificarCarrinho(), THROTTLE_LOGIN, Inject, precoDeReferencia(), VENDA_DE_PACOTE_REPOSITORY, VendaDePacoteRepository, INTENCAO_DE_PAGAMENTO_REPOSITORY, PRAZO_RESERVA_SEGUNDOS (+27 more)
...
Cohesion: 0.20
Nodes (6): CancelarReservaOnlineUseCase, Inject, Injectable, EmpresaPublicaQueryService, Injectable, Inject
...
Cohesion: 0.14
Nodes (15): ConfirmarPagamentoPresencialUseCase, Injectable, ConfirmarReembolsoInput, ConfirmarReembolsoUseCase, Inject, Injectable, SolicitarReembolsoInput, SolicitarReembolsoOutput (+7 more)

### Community 55 - "auth.controller.ts"
Cohesion: 0.08
Nodes (17): AuthProvider, LocalAuthProvider, Injectable, verificaSenha(), AuthController, LoginDto, TrocarSenhaDto, Body (+9 more)

### Community 56 - "pacotes-publico.controller.ts"
Cohesion: 0.18
Nodes (7): CLIENTE_REPOSITORY, ClienteSessaoService, Injectable, ClienteGuard, ClienteGuardOpcional, Inject, Injectable
...
Cohesion: 0.06
Nodes (25): IniciarLoginClienteInput, IniciarLoginClienteOutput, IniciarLoginClienteUseCase, Inject, Injectable, OnPacoteVendidoHandler, Inject, Injectable (+17 more)

### Community 59 - "vender-produto-avulso.usecase.ts"
Cohesion: 0.18
Nodes (10): Injectable, VenderProdutoAvulsoInput, VenderProdutoAvulsoUseCase, Injectable, VendasProdutoQueryService, Controller, Get, VendasProdutoController (+2 more)
...
### Community 67 - "Timezone"
Cohesion: 0.12
Nodes (7): ticketMedioCentavos(), ComissaoQueryService, Injectable, HomeQueryService, Injectable, Inject, Timezone
...
Cohesion: 0.09
Nodes (18): PacoteOfertasQueryService, paraDTO(), Inject, Injectable, PacotesPublicoController, Body, Controller, Get (+10 more)
...
Cohesion: 0.09
Nodes (23): CLIENTE_DA_CASA_REPOSITORY, ClienteDaCasaRepository, PrismaClienteDaCasaRepository, Injectable, MarcarDaCasaDto, IsOptional, IsString, MinLength (+15 more)

### Community 85 - "abacatepay.gateway.ts"
Cohesion: 0.24
...
### Community 92 - "booking-publico.controller.ts"
Cohesion: 0.09
Nodes (11): ItemDeOrderBump, ItemDeOrderBumpProps, MAX_MENSAGEM_BUMP, TipoItemDeOrderBump, ITEM_DE_ORDER_BUMP_REPOSITORY, ItemDeOrderBumpRepository, BASE, criar() (+3 more)
...
Cohesion: 0.13
Nodes (9): ProcessarWebhookUseCase, Injectable, RepositoriosTransacionais, PrismaUnitOfWork, repositoriosDe(), Injectable, prisma, publisherSilencioso (+1 more)

### Community 107 - "ConfigurarDto"
Cohesion: 0.25
Nodes (8): ConfigurarDto, IsBoolean, IsInt, IsOptional, IsPositive, IsString, MaxLength, Min

### Community 108 - "ParametrosDaEmpresaRepository"
Cohesion: 0.08
Nodes (18): AUTH_PROVIDER, PAPEIS_KEY, PUBLICO_KEY, Inject, PARAMETROS_DA_EMPRESA_REPOSITORY, ParametrosDaEmpresaRepository, Inject, FechamentoQueryService (+10 more)
...
Cohesion: 0.11
Nodes (13): CancelarAtendimentoUseCase, Injectable, ConcluirAtendimentoUseCase, consumirCreditosDePacote(), Injectable, RegistrarNaoComparecimentoUseCase, Inject, Injectable (+5 more)
...
### Community 122 - "fuso-horario.spec.ts"
Cohesion: 0.12
Nodes (11): ExpirarItensJob, Cron, Inject, Injectable, AgendaQueryService, Injectable, agenda, prisma (+3 more)
...
### Community 160 - "CobrancaOnlineService"
Cohesion: 0.15
Nodes (8): Inject, Injectable, VenderPacoteUseCase, CobrancaOnlineService, Inject, Injectable, criar(), ConfigPagamentoManual
...
Cohesion: 0.04
Nodes (28): ClienteProps, NOME_PLACEHOLDER, criar(), ConfirmarLoginClienteInput, ConfirmarLoginClienteOutput, Telefone, DIA, e164() (+20 more)
...
Cohesion: 0.18
Nodes (15): DefinirExpedienteInput, DefinirExpedienteUseCase, Inject, Injectable, MaterializarExpedienteInput, DiaSemana, ExpedienteSemanalProps, JanelaExpediente (+7 more)
...
### Community 225 - ".vender"
Cohesion: 0.33
Nodes (3): registrar(), Body, Post
...
### Community 229 - "JanelaExpedienteDto"
Cohesion: 0.67
...
### Community 239 - "NegarValeUseCase"
Cohesion: 0.40
...
### Community 243 - "ConfirmarLoginClienteUseCase"
Cohesion: 0.50
...
## Knowledge Gaps
- **1153 isolated node(s):** `name`, `version`, `private`, `type`, `build` (+1148 more)
...
- **Why does `Cliente` connect `Cliente` to `dinheiro.ts`, `Telefone`, `agendar-avulso.usecase.ts`, `vender-pacote.usecase.ts`, `shared.module.ts`?**
