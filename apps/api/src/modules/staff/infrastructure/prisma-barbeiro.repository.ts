...
type Row = BarbeiroPrisma & { excecoesComissao: ExcecaoComissao[]; servicosAtendidos: BarbeiroServico[] };

const include = { excecoesComissao: true, servicosAtendidos: true } as const;
