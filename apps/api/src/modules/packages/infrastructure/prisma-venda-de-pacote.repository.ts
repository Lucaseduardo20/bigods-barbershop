...
function paraDominio(row: Row): VendaDePacote {
  return VendaDePacote.reconstituir({
    ...
    saldoUtilizado: Dinheiro.deCentavos(row.saldoUtilizadoCentavos),
    saldoReservadoReembolso: Dinheiro.deCentavos(row.saldoReservadoReembolsoCentavos),
    saldoReembolsado: Dinheiro.deCentavos(row.saldoReembolsadoCentavos),
    saldoResidualDesde: row.saldoResidualDesde,
...
export class PrismaVendaDePacoteRepository implements VendaDePacoteRepository {
  ...
  async salvar(venda: VendaDePacote): Promise<void> {
    const dadosVenda = {
      ...
      saldoUtilizadoCentavos: venda.saldoUtilizado.centavos,
      saldoReservadoReembolsoCentavos: venda.saldoReservadoReembolso.centavos,
      saldoReembolsadoCentavos: venda.saldoReembolsado.centavos,
      saldoResidualDesde: venda.saldoResidualDesde,
